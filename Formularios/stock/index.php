...
<body>
    ...
    <div class="container-lg mt-5">
        ...
        <h1 class="text-center bg-danger text-light ">Prisioneros</h1>
            ...
            <table class="table table-hover">
                <thead class="table-dark">
                    <tr>
                        ...
                        <th scope="col">motEnc</th>
                    </tr>
                </thead>
                <tbody>
                    <?php
                    $sql = $conexion->query("SELECT * FROM tbl_prisioneros");
                    ...
                    ?>
                        <tr>
                            ...
                            <th scope="row"><?php echo $resultado['motEnc'] ?></th>
                            <th scope="row">
                                <a href="<?php echo base_url; ?>Formularios/stock/actualizar.php?Id=<?php echo $resultado['idpreso'] ?>" class="btn btn-outline-warning">
                                    <i class="fa-solid fa-pen-to-square fa-beat"></i>
                                </a>
                                <a href="<?php echo base_url; ?>CRUDM/eliminarDatos.php?Id=<?php echo $resultado['idpreso'] ?>" class="btn btn-outline-danger">
